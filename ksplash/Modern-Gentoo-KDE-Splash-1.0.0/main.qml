...
//     }
    ...
    Text {
	  id: loadingText
            ...
            text: '<font color="white"><b>L</b>oading <b>Gentoo</b></font>'
     ...
     Text {
	  id: message
            // HTML like markup can also be used
            text: '<font color="white">Welcome to <b>KDE</b> the most Modern Desktop Environment.</font>'
    ...
    Text {
     ...
     Text {
	  id: textKDE
            // HTML like markup can also be used
	     text: '<font color="white"><b>Gentoo</b></font>'
     ...
     Text {
	  id: textGentoo
            // HTML like markup can also be used
	     text: '<font color="white">If it moves, <b>compile it.</b></font>'

            // This could also be written font { pointSize: 14 }. Both syntaxes are valid.
            font.pointSize: 18

            // StyledText format supports fewer tags, but is more efficient than RichText
            textFormat: Te100xt.StyledText
